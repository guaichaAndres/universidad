...
a persistence unit "universidadPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "universidad\pom.xml":
...
artifact ("universidad.war") is already built. You can build
